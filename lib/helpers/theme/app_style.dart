...
import 'package:hse_project/helpers/widgets/my.dart';
import 'package:hse_project/helpers/widgets/my_breadcrumb_item.dart';
import 'package:hse_project/helpers/widgets/my_constant.dart';
  ...
  static void initMyStyle() {
    ...
    My.setConstant(MyConstantData(
      ...
      defaultBreadCrumbItem:
          MyBreadcrumbItem(name: 'hse_project', route: '/dashboard'),
    ));
    bool isMobile = true;
    try {
